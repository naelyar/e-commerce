...
export const PrdouctSinglePage = () => {
  const { id } = useParams();
        ...
        <div className='product-single-content bg-white grid'>
          ...
          <div className='price'>
            <div className='flex align-center'>
              <div className='old-price text-green '>
                {formatPrice(product?.price)}
              </div>
              <spn className='fs-14 mx-2 text-dark'>Inclusive of all taxes</spn>
            </div>
          ...
          <div className='qty flex align-center my-4'>
            <div className='qty-text'>Quatity:</div>
            <div className='qty-change flex align-center mx-3'>
              <button
                type='button'
                className='qty-descrease flex align-center justify-center'
